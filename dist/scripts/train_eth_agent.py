...
MODEL_PATH = "models/eth_v1.onnx"
DIST_PATH = "dist/models/eth_v1.onnx"
...
# === Main ===
def main():
    print(f"Starting ETH AI Agent Training Session ({EPOCHS} Epochs)...")
    ...
    with open("models/eth_scaler.json", "w") as f:
        json.dump(scaler_params, f)
    import shutil
    shutil.copy("models/eth_scaler.json", "dist/models/eth_scaler.json")
    print(f"Scaler params saved to models/eth_scaler.json")
